...
- **Contact data protection officer** — composes an email to [pantherainsight@gmail.com](mailto:pantherainsight@gmail.com).
...
The **Delete account** tile lets you remove your access to the app. The flow is two-step:

1. Tap **Delete account**.
2. The first dialog explains what will be removed (your access, your local data) and what Panthera must retain for regulatory reasons (the reports themselves and the records of who they were prepared for). Read it and confirm.
...
??? tip "If deletion fails"
    The snackbar reads **"We could not delete your account just now. Please try again, or contact the data protection officer if this keeps happening."** Check your internet connection and try once more. If it keeps failing, email [pantherainsight@gmail.com](mailto:pantherainsight@gmail.com) and the DPO will action the deletion on the server side.
